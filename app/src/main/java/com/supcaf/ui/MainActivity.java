...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            } else if (id == R.id.nav_achats) {
                fragment = new AchatsFragment();
            } else if (id == R.id.nav_ventes) {
                fragment = new VentesFragment();
            } else if (id == R.id.nav_tiers) {
                fragment = new TiersFragment();
    ...
    /** Permet aux fragments de changer l'onglet actif */
